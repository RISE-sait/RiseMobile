    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Appointments",
          headerShown: false,
          tabBarIcon: ({ focused }) => <TabIcon icon={icons.calendar} title="Appointments" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="services"
        options={{
          title: "Services",
          headerShown: false,
          tabBarIcon: ({ focused }) => <TabIcon icon={icons.scissors} title="Services" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="profile"
...
export default BarberTabsLayout
