...
const featuredFacilities = [
  ...
  },
  {
    ...
    route: "/screens/instructor-booking/practiceBooking",
  },
]
...
const InstructorBook = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      >
        <View>
          <Text style={{ color: COLORS.text, fontSize: 28, fontWeight: "bold" }}>Instructor Bookings</Text>
