...
const CoachCalendar = () => {
  ...
  const [events, setEvents] = useState<Record<string, any[]>>({}); // Replace `any` with your event type
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const sampleEvents = {
        "2025-01-31": [
          { id: "1", title: "Team Practice", time: "10:00 AM" },
          { id: "2", title: "Strategy Meeting", time: "2:00 PM" },
        ],
      };
  ...
  return (
    <SafeAreaView className="bg-gray-900 flex-1">
      ...
      {/* Header */}
      <View className="py-5">
        <Text className="text-center text-3xl font-Oswald-SemiBold text-white-100">Coach Calendar</Text>
      </View>
      ...
      <View className="flex-1 bg-gray-800 rounded-t-3xl p-5 shadow-lg">
        {loading ? (
          ...
          <>
            <Text className="text-lg font-Oswald-Bold text-white-100 mb-3">
